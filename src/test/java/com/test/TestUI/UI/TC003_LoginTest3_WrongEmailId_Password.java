...
public class TC003_LoginTest3_WrongEmailId_Password extends TestBase {
	
	public static final Logger log = Logger.getLogger(TC003_LoginTest3_WrongEmailId_Password.class.getName());
	...
	@Test
	public void loginTest3_WrongEmailId_Password() {
		...
		login_cred=excel.getCellData(filepath,"loginData.xlsx", "login",3);
			...
			String text=loginpage.login(email_id, password,3);
	
		    Assert.assertEquals("Invalid Email or Password",text);
		 
		 ss.CaptureScreenShot(driver,"TC003-LoginTest3_WrongEmailId_Password"); // Capturing Screen Shot	 
	}
